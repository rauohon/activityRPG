		...
		<div class="signup-form-container">
			...
			<form role="form"  id="register-form" autocomplete="off" action="Join" method="post">
				...
				<div class="form-body">
					...
					<div class="row">
						...
						<div class="form-group col-lg-6">
							<div class="input-group">
								...
								<input name="spwd" type="password" class="form-control"
					...
					<!-- 성별  :: 라디오 버튼 -->
					<div class="btn-group" data-toggle="buttons" style="margin-bottom: 13px">
						<!-- <div>
				...
				<div class="form-footer">
					...
					<!-- <input type="button" value="회원가입" onClick="sendJoin()" /> -->
				</div>
			</form>
		</div>
	</div>
